...
HD_PWD='G:/XilinxPrograms/2024_finger_lhk/2024_finger_lhk.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_finger_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_finger_wrapper.tcl -notrace
