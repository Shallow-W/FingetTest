...
HD_PWD='G:/XilinxPrograms/2024_finger_lhk/2024_finger_lhk.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_finger_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_finger_wrapper.tcl
