...
HD_PWD='G:/XilinxPrograms/2024_finger/2024_finger.runs/design_finger_ilmb_bram_if_cntlr_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_finger_ilmb_bram_if_cntlr_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_finger_ilmb_bram_if_cntlr_1.tcl
